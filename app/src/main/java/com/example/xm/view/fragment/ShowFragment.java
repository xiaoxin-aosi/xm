...
import com.example.xm.adapter.show.GridAdapter;
import com.example.xm.adapter.show.GridGoodAdapter;
import com.example.xm.adapter.show.GridMakeAdapter;
import com.example.xm.adapter.show.HotGoodsAdapter;
import com.example.xm.adapter.show.SinCategoryAdapter;
import com.example.xm.adapter.show.SinToplistAdapter;
import com.example.xm.adapter.show.SingleAdapter;
import com.example.xm.adapter.show.SingleText2Adapter;
import com.example.xm.adapter.show.SingleText3Adapter;
import com.example.xm.adapter.show.SingleText4Adapter;
